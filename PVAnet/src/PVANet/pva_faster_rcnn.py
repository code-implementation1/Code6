...
from src.PVANet.backbone import get_pvanet
from src.PVANet.bbox_assign_sample_stage2 import BboxAssignSampleForRcnn
from src.PVANet.fpn_neck import FeatPyramidNeck
from src.PVANet.proposal_generator import Proposal
from src.PVANet.rcnn import Rcnn
from src.PVANet.rpn import RPN
from src.PVANet.roi_align import SingleRoIExtractor
from src.PVANet.anchor_generator import AnchorGenerator
...
class PVANet(nn.Cell):
    ...
    def __init__(self, config):
        ...
        # Backbone
        self.backbone = get_pvanet(pretrained=False)
...
class PVANetInfer(nn.Cell):
    def __init__(self, config):
        super(PVANetInfer, self).__init__()
        self.network = PVANet(config)
